...
### a MetSim .conf file for  ###
################################

#declare list of station numbers used in file control
...
#Calculate number of stations for looping
$length= @SID;
# $length=1;
	...
	{	
	#declare snotel ID array
	$ID=@SID[$TT];
	
	#Create naming variables for output files
	$name = "snotel_";
	$period = ".";
	$under = "_";
	$nc = ".nc";
	...
	#write configuration scirpt to file. Some variables can be seen in the code below marked with "$".
	open(CODE, ">$file");
	print CODE <<"END";
