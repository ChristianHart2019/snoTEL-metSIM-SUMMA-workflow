############################################################
### Python MetSim time-stamp and data correction.		 ###
...
# 		scid = nc4.Dataset(datafile[z], "r", format="NETCDF4")		# Open nldas data files for reading 			
		...
		dimid_T = ncid.createDimension('time',len(mcid.variables['time']))
		...
		# Assign variable  valuep
		wind_varid[:]=data											# Assign NLDAS data to file
...
# 		scid.close()												# close MetSim Datafile
